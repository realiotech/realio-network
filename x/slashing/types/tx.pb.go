...
func init() {
	proto.RegisterType((*MsgUnjail)(nil), "realiotech.network.slashing.MsgUnjail")
	proto.RegisterType((*MsgUnjailResponse)(nil), "realiotech.network.slashing.MsgUnjailResponse")
}
...
var fileDescriptor_8f2ef99a2cd3e725 = []byte{
	...
	,
	...
	0x69, 0x92, 0x5e, 0x72, 0x7e, 0xae, 0x3e, 0xc2, 0x5c, 0x28, 0x53, 0x17, 0x6a, 0xbc, 0x7e, 0x85,
	0x3e, 0x22, 0x94, 0x2b, 0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0xc1, 0x66, 0x0c, 0x08, 0x00, 0x00,
	0xff, 0xff, 0x1a, 0x50, 0x46, 0x98, 0x7e, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) Unjail(ctx context.Context, in *MsgUnjail, opts ...grpc.CallOption) (*MsgUnjailResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/realiotech.network.slashing.Msg/Unjail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Unjail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/realiotech.network.slashing.Msg/Unjail",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "realiotech.network.slashing.Msg",
