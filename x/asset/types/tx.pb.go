...
type MsgCreateToken struct {
	...
	EnabledPrivileges  []string `protobuf:"bytes,9,rep,name=enabled_privileges,json=enabledPrivileges,proto3" json:"enabled_privileges,omitempty"`
}
...
func (m *MsgCreateToken) GetEnabledPrivileges() []string {
	if m != nil {
...
var fileDescriptor_1cfda60866e68e13 = []byte{
	...
	,
}
...
func (m *MsgCreateToken) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.EnabledPrivileges) > 0 {
		for iNdEx := len(m.EnabledPrivileges) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintTx(dAtA, i, uint64(len(m.EnabledPrivileges[iNdEx])))
			i--
			dAtA[i] = 0x4a
		}
	}
