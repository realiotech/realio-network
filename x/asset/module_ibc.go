...
func (am AppModule) OnRecvPacket(
	...
	var modulePacketData types.AssetPacketData
	...
	case *types.AssetPacketData_FungibleTokenTransferPacket:
		packetAck, err := am.keeper.OnRecvFungibleTokenTransferPacket(ctx, modulePacket, *packet.FungibleTokenTransferPacket)
		if err != nil {
		...
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				types.EventTypeFungibleTokenTransferPacket,
...
func (am AppModule) OnAcknowledgementPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.AssetPacketData_FungibleTokenTransferPacket:
		err := am.keeper.OnAcknowledgementFungibleTokenTransferPacket(ctx, modulePacket, *packet.FungibleTokenTransferPacket, ack)
		if err != nil {
			return nil, err
		}
		eventType = types.EventTypeFungibleTokenTransferPacket
...
func (am AppModule) OnTimeoutPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.AssetPacketData_FungibleTokenTransferPacket:
		err := am.keeper.OnTimeoutFungibleTokenTransferPacket(ctx, modulePacket, *packet.FungibleTokenTransferPacket)
		if err != nil {
			return nil, err
		}
