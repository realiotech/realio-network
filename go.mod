...
replace (
	github.com/cosmos/evm => github.com/realiotech/evm v0.6.3
	...
	github.com/realio-tech/multi-staking-module => github.com/realiotech/multi-staking v1.2.1-0.20260901090728-9da510ce46da
