...
replace (
	github.com/cosmos/evm => github.com/realiotech/evm v0.5.1-realio
	...
	github.com/realio-tech/multi-staking-module => github.com/realiotech/multi-staking v1.2.0-rc2.0.20251110105803-186b12b4bab1
