...
replace (
	// Our cosmos-sdk branch is:  https://github.com/realiotech/cosmos-sdk v0.45.x-realio-beta-0.3
	github.com/cosmos/cosmos-sdk => github.com/realiotech/cosmos-sdk v0.45.2-0.20220901205725-e4ed85f602ac
