...
require (
	...
	cosmossdk.io/client/v2 v2.11.0-rc.1
...
require (
	...
	cosmossdk.io/log/v2 v2.1.0-rc.1 // indirect
	...
	github.com/cosmos/cosmos-sdk/store/v2 v2.0.0-rc.1 // indirect
...
replace (
	github.com/cosmos/evm => github.com/realiotech/evm v0.5.3
	...
	github.com/realio-tech/multi-staking-module => github.com/realiotech/multi-staking v1.2.0
