...
import { ValidatorAccumulatedCommission, ValidatorHistoricalRewards, ValidatorCurrentRewards, DelegatorStartingInfo, ValidatorSlashEvent, Params, FeePool } from '../distribution/distribution';
export declare const protobufPackage = "realiotech.network.distribution";
/**
