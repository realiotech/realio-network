...
export const ValidatorHistoricalRewards = {
  encode(message: ValidatorHistoricalRewards, writer: Writer = Writer.create()): Writer {
...
export const ValidatorCurrentRewards = {
  encode(message: ValidatorCurrentRewards, writer: Writer = Writer.create()): Writer {
...
export const ValidatorAccumulatedCommission = {
  encode(message: ValidatorAccumulatedCommission, writer: Writer = Writer.create()): Writer {
...
export const ValidatorOutstandingRewards = {
  encode(message: ValidatorOutstandingRewards, writer: Writer = Writer.create()): Writer {
    for (const v of message.rewards) {
      DecCoin.encode(v!, writer.uint32(10).fork()).ldelim()
    }
    return writer
...
export const ValidatorSlashEvent = {
  encode(message: ValidatorSlashEvent, writer: Writer = Writer.create()): Writer {
...
export const ValidatorSlashEvents = {
  encode(message: ValidatorSlashEvents, writer: Writer = Writer.create()): Writer {
...
export const CommunityPoolSpendProposal = {
  encode(message: CommunityPoolSpendProposal, writer: Writer = Writer.create()): Writer {
    if (message.title !== '') {
...
const baseDelegatorStartingInfo: object = { previousPeriod: 0, stake: '', height: 0 }

export const DelegatorStartingInfo = {
  encode(message: DelegatorStartingInfo, writer: Writer = Writer.create()): Writer {
...
export const DelegationDelegatorReward = {
  encode(message: DelegationDelegatorReward, writer: Writer = Writer.create()): Writer {
...
export const CommunityPoolSpendProposalWithDeposit = {
  encode(message: CommunityPoolSpendProposalWithDeposit, writer: Writer = Writer.create()): Writer {
    if (message.title !== '') {
      writer.uint32(10).string(message.title)
    }
    if (message.description !== '') {
