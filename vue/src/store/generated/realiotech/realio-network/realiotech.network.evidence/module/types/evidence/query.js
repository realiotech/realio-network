...
export const protobufPackage = 'realiotech.network.evidence';
...
export class QueryClientImpl {
    ...
    Evidence(request) {
        ...
        const promise = this.rpc.request('realiotech.network.evidence.Query', 'Evidence', data);
    ...
    AllEvidence(request) {
        ...
        const promise = this.rpc.request('realiotech.network.evidence.Query', 'AllEvidence', data);
