...
import { Params, ValidatorSigningInfo } from "../slashing/slashing";
import { PageRequest, PageResponse, } from "../cosmos/base/query/v1beta1/pagination";
export const protobufPackage = "realiotech.network.slashing";
...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("realiotech.network.slashing.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    SigningInfo(request) {
        const data = QuerySigningInfoRequest.encode(request).finish();
        const promise = this.rpc.request("realiotech.network.slashing.Query", "SigningInfo", data);
    ...
    SigningInfos(request) {
        ...
        const promise = this.rpc.request("realiotech.network.slashing.Query", "SigningInfos", data);
