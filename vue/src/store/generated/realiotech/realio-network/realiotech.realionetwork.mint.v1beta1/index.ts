...
import { Minter } from "./module/types/mint/v1beta1/mint"
import { Params } from "./module/types/mint/v1beta1/mint"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: realiotech.realionetwork.mint.v1beta1 initialized!')
