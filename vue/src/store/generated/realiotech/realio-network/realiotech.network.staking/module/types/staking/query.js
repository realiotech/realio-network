...
import { Validator, DelegationResponse, UnbondingDelegation, RedelegationResponse, HistoricalInfo, Pool, Params, } from "../staking/staking";
export const protobufPackage = "realiotech.network.staking";
...
export class QueryClientImpl {
    ...
    Validators(request) {
        ...
        const promise = this.rpc.request("realiotech.network.staking.Query", "Validators", data);
        return promise.then((data) => QueryValidatorsResponse.decode(new Reader(data)));
    }
    Validator(request) {
        const data = QueryValidatorRequest.encode(request).finish();
        const promise = this.rpc.request("realiotech.network.staking.Query", "Validator", data);
    ...
    ValidatorDelegations(request) {
        ...
        const promise = this.rpc.request("realiotech.network.staking.Query", "ValidatorDelegations", data);
    ...
    ValidatorUnbondingDelegations(request) {
        ...
        const promise = this.rpc.request("realiotech.network.staking.Query", "ValidatorUnbondingDelegations", data);
    ...
    Delegation(request) {
        ...
        const promise = this.rpc.request("realiotech.network.staking.Query", "Delegation", data);
    ...
    UnbondingDelegation(request) {
        ...
        const promise = this.rpc.request("realiotech.network.staking.Query", "UnbondingDelegation", data);
    ...
    DelegatorDelegations(request) {
        ...
        const promise = this.rpc.request("realiotech.network.staking.Query", "DelegatorDelegations", data);
    ...
    DelegatorUnbondingDelegations(request) {
        ...
        const promise = this.rpc.request("realiotech.network.staking.Query", "DelegatorUnbondingDelegations", data);
    ...
    Redelegations(request) {
        ...
        const promise = this.rpc.request("realiotech.network.staking.Query", "Redelegations", data);
        return promise.then((data) => QueryRedelegationsResponse.decode(new Reader(data)));
    }
    DelegatorValidators(request) {
        const data = QueryDelegatorValidatorsRequest.encode(request).finish();
        const promise = this.rpc.request("realiotech.network.staking.Query", "DelegatorValidators", data);
    ...
    DelegatorValidator(request) {
        ...
        const promise = this.rpc.request("realiotech.network.staking.Query", "DelegatorValidator", data);
        return promise.then((data) => QueryDelegatorValidatorResponse.decode(new Reader(data)));
    }
    HistoricalInfo(request) {
        const data = QueryHistoricalInfoRequest.encode(request).finish();
        const promise = this.rpc.request("realiotech.network.staking.Query", "HistoricalInfo", data);
        return promise.then((data) => QueryHistoricalInfoResponse.decode(new Reader(data)));
    }
    Pool(request) {
        const data = QueryPoolRequest.encode(request).finish();
        const promise = this.rpc.request("realiotech.network.staking.Query", "Pool", data);
        return promise.then((data) => QueryPoolResponse.decode(new Reader(data)));
    }
    Params(request) {
        const data = QueryParamsRequest.encode(request).finish();
        const promise = this.rpc.request("realiotech.network.staking.Query", "Params", data);
