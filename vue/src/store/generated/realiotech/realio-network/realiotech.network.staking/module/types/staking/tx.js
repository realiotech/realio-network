...
import { Description, CommissionRates } from "../staking/staking";
...
export class MsgClientImpl {
    ...
    CreateValidator(request) {
        ...
        const promise = this.rpc.request("realiotech.network.staking.Msg", "CreateValidator", data);
        return promise.then((data) => MsgCreateValidatorResponse.decode(new Reader(data)));
    }
    EditValidator(request) {
        const data = MsgEditValidator.encode(request).finish();
        const promise = this.rpc.request("realiotech.network.staking.Msg", "EditValidator", data);
        return promise.then((data) => MsgEditValidatorResponse.decode(new Reader(data)));
    }
    Delegate(request) {
        const data = MsgDelegate.encode(request).finish();
        const promise = this.rpc.request("realiotech.network.staking.Msg", "Delegate", data);
        return promise.then((data) => MsgDelegateResponse.decode(new Reader(data)));
    }
    BeginRedelegate(request) {
        const data = MsgBeginRedelegate.encode(request).finish();
        const promise = this.rpc.request("realiotech.network.staking.Msg", "BeginRedelegate", data);
        return promise.then((data) => MsgBeginRedelegateResponse.decode(new Reader(data)));
    }
    Undelegate(request) {
        const data = MsgUndelegate.encode(request).finish();
        const promise = this.rpc.request("realiotech.network.staking.Msg", "Undelegate", data);
