...
export const protobufPackage = 'realiotech.network.gov'
...
const baseQueryProposalsRequest: object = { proposalStatus: 0, voter: '', depositor: '' }
...
const baseQueryVoteRequest: object = { proposalId: 0, voter: '' }
...
const baseQueryVotesRequest: object = { proposalId: 0 }
...
const baseQueryDepositRequest: object = { proposalId: 0, depositor: '' }
...
const baseQueryDepositsRequest: object = { proposalId: 0 }
...
export class QueryClientImpl implements Query {
  ...
  Proposal(request: QueryProposalRequest): Promise<QueryProposalResponse> {
    ...
    const promise = this.rpc.request('realiotech.network.gov.Query', 'Proposal', data)
    return promise.then((data) => QueryProposalResponse.decode(new Reader(data)))
  }

  Proposals(request: QueryProposalsRequest): Promise<QueryProposalsResponse> {
    const data = QueryProposalsRequest.encode(request).finish()
    const promise = this.rpc.request('realiotech.network.gov.Query', 'Proposals', data)
    return promise.then((data) => QueryProposalsResponse.decode(new Reader(data)))
  }

  Vote(request: QueryVoteRequest): Promise<QueryVoteResponse> {
    const data = QueryVoteRequest.encode(request).finish()
    const promise = this.rpc.request('realiotech.network.gov.Query', 'Vote', data)
    return promise.then((data) => QueryVoteResponse.decode(new Reader(data)))
  }

  Votes(request: QueryVotesRequest): Promise<QueryVotesResponse> {
    const data = QueryVotesRequest.encode(request).finish()
    const promise = this.rpc.request('realiotech.network.gov.Query', 'Votes', data)
    return promise.then((data) => QueryVotesResponse.decode(new Reader(data)))
  }

  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    const data = QueryParamsRequest.encode(request).finish()
    const promise = this.rpc.request('realiotech.network.gov.Query', 'Params', data)
    return promise.then((data) => QueryParamsResponse.decode(new Reader(data)))
  }

  Deposit(request: QueryDepositRequest): Promise<QueryDepositResponse> {
    const data = QueryDepositRequest.encode(request).finish()
    const promise = this.rpc.request('realiotech.network.gov.Query', 'Deposit', data)
    return promise.then((data) => QueryDepositResponse.decode(new Reader(data)))
  }

  Deposits(request: QueryDepositsRequest): Promise<QueryDepositsResponse> {
    const data = QueryDepositsRequest.encode(request).finish()
    const promise = this.rpc.request('realiotech.network.gov.Query', 'Deposits', data)
    return promise.then((data) => QueryDepositsResponse.decode(new Reader(data)))
  }

  TallyResult(request: QueryTallyResultRequest): Promise<QueryTallyResultResponse> {
    const data = QueryTallyResultRequest.encode(request).finish()
    const promise = this.rpc.request('realiotech.network.gov.Query', 'TallyResult', data)
