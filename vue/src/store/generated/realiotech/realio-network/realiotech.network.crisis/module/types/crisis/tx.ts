...
export const protobufPackage = 'realiotech.network.crisis'
...
export const MsgVerifyInvariant = {
  encode(message: MsgVerifyInvariant, writer: Writer = Writer.create()): Writer {
    if (message.sender !== '') {
...
export const MsgVerifyInvariantResponse = {
  encode(_: MsgVerifyInvariantResponse, writer: Writer = Writer.create()): Writer {
    return writer
  },
...
export class MsgClientImpl implements Msg {
  ...
  VerifyInvariant(request: MsgVerifyInvariant): Promise<MsgVerifyInvariantResponse> {
    ...
    const promise = this.rpc.request('realiotech.network.crisis.Msg', 'VerifyInvariant', data)
