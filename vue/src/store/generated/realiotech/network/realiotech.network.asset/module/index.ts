...
import { MsgSendFungibleTokenTransfer } from "./types/asset/tx";
...
const types = [
  ...
  ["/realiotech.network.asset.MsgSendFungibleTokenTransfer", MsgSendFungibleTokenTransfer],
...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgSendFungibleTokenTransfer: (data: MsgSendFungibleTokenTransfer): EncodeObject => ({ typeUrl: "/realiotech.network.asset.MsgSendFungibleTokenTransfer", value: data }),
