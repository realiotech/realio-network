...
import { MsgSendToAlgorand } from "./types/asset/tx";
...
const types = [
  ...
  ["/realiotech.network.asset.MsgSendToAlgorand", MsgSendToAlgorand],
...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgSendToAlgorand: (data: MsgSendToAlgorand): EncodeObject => ({ typeUrl: "/realiotech.network.asset.MsgSendToAlgorand", value: data }),
