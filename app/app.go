...
var (
	...
	_ simapp.App              = (*RealioNetwork)(nil)
...
func New(
	...
	*/
	...
	app.EvmKeeper = evmkeeper.NewKeeper(
		...
		app.FeeMarketKeeper, nil, geth.NewEVM, tracer,
	)
...
func (app *RealioNetwork) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
