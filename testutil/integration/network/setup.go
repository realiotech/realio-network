...
type genSetupFn func(cosmosEVMApp *app.RealioNetwork, genesisState simapp.GenesisState, customGenesis interface{}) (simapp.GenesisState, error)
...
func genStateSetter[T proto.Message](moduleName string) genSetupFn {
	return func(cosmosEVMApp *app.RealioNetwork, genesisState simapp.GenesisState, customGenesis interface{}) (simapp.GenesisState, error) {
...
func createTestingApp(chainID string, customBaseAppOptions ...func(*baseapp.BaseApp)) *app.RealioNetwork {
	// Create evmos app
	db := dbm.NewMemDB()
...
func setDefaultStakingGenesisState(cosmosEVMApp *app.RealioNetwork, genesisState simapp.GenesisState, overwriteParams StakingCustomGenesisState) simapp.GenesisState {
	// Set staking params
	...
	multiGen := multistakingtypes.DefaultGenesis()
	multiGen.MultiStakingCoinInfo = []multistakingtypes.MultiStakingCoinInfo{
		{Denom: constants.ExampleAttoDenom, BondWeight: math.LegacyOneDec()},
		{Denom: "arst", BondWeight: math.LegacyOneDec()},
	}
	multiGen.StakingGenesisState = *stakingGenesis

	genesisState[multistakingtypes.ModuleName] = cosmosEVMApp.AppCodec().MustMarshalJSON(multiGen)
...
func setDefaultBankGenesisState(cosmosEVMApp *app.RealioNetwork, genesisState simapp.GenesisState, overwriteParams BankCustomGenesisState) simapp.GenesisState {
...
func setDefaultSlashingGenesisState(cosmosEVMApp *app.RealioNetwork, genesisState simapp.GenesisState, overwriteParams SlashingCustomGenesisState) simapp.GenesisState {
...
func setBankGenesisState(cosmosEVMApp *app.RealioNetwork, genesisState simapp.GenesisState, customGenesis interface{}) (simapp.GenesisState, error) {
...
func setDefaultAuthGenesisState(cosmosEVMApp *app.RealioNetwork, genesisState simapp.GenesisState, genAccs []authtypes.GenesisAccount) simapp.GenesisState {
...
func setAuthGenesisState(cosmosEVMApp *app.RealioNetwork, genesisState simapp.GenesisState, customGenesis interface{}) (simapp.GenesisState, error) {
...
func setDefaultMintGenesisState(cosmosEVMApp *app.RealioNetwork, genesisState simapp.GenesisState, overwriteParams MintCustomGenesisState) simapp.GenesisState {
...
// func setDefaultMultiStakingGenesisState(cosmosEVMApp *app.RealioNetwork, genesisState simapp.GenesisState) simapp.GenesisState {
// 	// NOTE: here we are using the setup from the example chain
// 	multiGen := multistakingtypes.DefaultGenesis()
// 	multiGen.MultiStakingCoinInfo = []multistakingtypes.MultiStakingCoinInfo{
// 		{Denom: constants.ExampleAttoDenom, BondWeight: math.LegacyOneDec()},
...
func newDefaultGenesisState(cosmosEVMApp *app.RealioNetwork, params defaultGenesisParams) simapp.GenesisState {
...
func customizeGenesis(cosmosEVMApp *app.RealioNetwork, customGen CustomGenesisState, genesisState simapp.GenesisState) (simapp.GenesisState, error) {
	var err error
